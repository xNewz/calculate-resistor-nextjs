        ...
        <div className="grid lg:grid-cols-[220px_1fr] gap-6">
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-6">
                <div className="bg-zinc-900/40 border border-zinc-800 rounded-2xl p-6 space-y-4">
                  ...
                  <p className="text-zinc-300 text-sm leading-relaxed">
                    <strong className="text-white">มัลติมิเตอร์ (Multimeter)</strong> เป็นเครื่องมือวัดทางไฟฟ้าที่รวมเอาความสามารถในการวัดหลายๆ อย่างมารวมไว้ในเครื่องเดียว เช่น การวัดแรงดันไฟฟ้า (Voltage), กระแสไฟฟ้า (Current), และความต้านทานไฟฟ้า (Resistance)
                  </p>
                  <p className="text-zinc-400 text-sm leading-relaxed">
                    ในบทเรียนนี้เราจะเน้นศึกษา <strong className="text-white">มัลติมิเตอร์แบบอนาล็อก (แบบเข็มชี้)</strong> ซึ่งต้องอาศัยการอ่านค่าจากสเกลบนหน้าปัดร่วมกับตำแหน่งการตั้งค่าของปุ่มปรับย่านวัด เพื่อให้เข้าใจหลักการวัดพื้นฐานอย่างลึกซึ้ง
                  </p>
                  <div className="grid sm:grid-cols-2 gap-4 pt-2">
                    <div className="bg-zinc-950/40 border border-zinc-800/80 rounded-xl p-4 space-y-2">
                      <h3 className="font-bold text-zinc-200 text-xs uppercase tracking-wider text-indigo-400">ขั้วและสายวัด (Probes)</h3>
                      <p className="text-xs text-zinc-400 leading-relaxed">
                        สายวัดมี 2 สีหลัก: <span className="text-red-400 font-bold">สีแดง (+)</span> สำหรับขั้วบวก และ <span className="text-zinc-400 font-bold">สีดำ (-)</span> สำหรับขั้วลบ (COM)
                      </p>
                    </div>
                    <div className="bg-zinc-950/40 border border-zinc-800/80 rounded-xl p-4 space-y-2">
                      <h3 className="font-bold text-zinc-200 text-xs uppercase tracking-wider text-amber-400">ปุ่มปรับย่านวัด (Selector Dial)</h3>
                      <p className="text-xs text-zinc-400 leading-relaxed">
                ...
                <div className="bg-zinc-900/40 border border-zinc-800 rounded-xl p-5 space-y-3">
                  ...
                  <div className="space-y-2 text-xs text-zinc-400 leading-relaxed">
                    <p>• <strong className="text-zinc-200">สเกลวัด (Scale):</strong> แถบเส้นโค้งที่มีตัวเลขระบุค่าอยู่บนหน้าปัด ใช้สำหรับดูตำแหน่งเข็มชี้</p>
                    <p>• <strong className="text-zinc-200">เข็มชี้ (Needle):</strong> ชี้ไปยังตัวเลขบนสเกลตามปริมาณไฟฟ้าที่วัดได้จริง</p>
                    <p>• <strong className="text-zinc-200">ปุ่มปรับศูนย์โอห์ม (0Ω Adjust):</strong> ใช้ปรับให้เข็มชี้ที่เลข 0 บนสเกลโอห์มพอดิบพอดีเมื่อนำสายวัดทั้งสองขั้วมาสัมผัสกัน (ก่อนทำการวัดทุกครั้ง)</p>
                  </div>
                </div>
            ...
            {activeLesson === "scale" && (
              <div className="space-y-6">
                <div className="bg-zinc-900/40 border border-zinc-800 rounded-2xl p-6 space-y-4">
                  <h2 className="text-xl font-black text-zinc-100 mb-1">การแบ่งสเกลบนหน้าปัดมัลติมิเตอร์</h2>
                  ...
                  <div className="grid sm:grid-cols-2 gap-4 pt-2">
                    <div className="bg-zinc-900/60 border border-zinc-800 rounded-xl p-5 space-y-3">
                      <div className="flex items-center gap-2">
                        ...
                        <h3 className="font-bold text-zinc-200 text-sm">สเกลโอห์ม (Resistance)</h3>
                      </div>
                      <p className="text-xs text-zinc-400 leading-relaxed">
                        • อยู่ที่ <strong className="text-blue-400">แถวบนสุด</strong> ของหน้าปัด มักเป็นเส้นสีดำ<br />
                        • เป็นสเกลแบบ <strong className="text-white">ไม่เป็นเชิงเส้น (Non-linear)</strong> (ฝั่งขวาขีดห่าง ฝั่งซ้ายขีดชิดกันมาก)<br />
                    ...
                    <div className="bg-zinc-900/60 border border-zinc-800 rounded-xl p-5 space-y-3">
                      <div className="flex items-center gap-2">
                        ...
                        <h3 className="font-bold text-zinc-200 text-sm">สเกลแรงดัน (DCV / ACV)</h3>
                      </div>
                      <p className="text-xs text-zinc-400 leading-relaxed">
                        • อยู่ที่ <strong className="text-emerald-400">แถวถัดลงมา</strong> มักมีสเกลหลักสามแถวคือ 0-10, 0-50, 0-250<br />
                        • เป็นสเกลแบบ <strong className="text-white">เป็นเชิงเส้น (Linear)</strong> มีระยะห่างเท่าๆ กันหมด<br />
                  ...
                  <div className="bg-zinc-950/50 border border-zinc-800 rounded-xl p-4">
                    <p className="text-xs font-bold text-zinc-400 uppercase tracking-wider mb-2">ข้อสังเกต</p>
                    <p className="text-xs text-zinc-400 leading-relaxed">
            ...
            {activeLesson === "ohm" && (
              <div className="space-y-6">
                <div className="bg-zinc-900/40 border border-zinc-800 rounded-2xl p-6 space-y-5">
                  <h2 className="text-xl font-black text-zinc-100">การอ่านและคำนวณย่านวัดโอห์ม (Ω)</h2>

                  <div className="bg-zinc-950/60 border border-zinc-800 rounded-xl p-4 space-y-2">
                    <p className="text-xs font-bold text-zinc-400 uppercase tracking-wider mb-3">สูตรการคำนวณความต้านทาน</p>
                    <div className="font-mono text-center text-sm sm:text-base font-bold text-zinc-100">
                  ...
                  <div className="space-y-4">
                    <h3 className="font-bold text-zinc-200 text-sm">การตั้งย่านวัดแต่ละประเภท</h3>
                    <div className="grid gap-3">
                      {[
                        ...
                        <div key={item.range} className="flex gap-4 p-3 bg-zinc-900/60 border border-zinc-850 rounded-xl items-center">
                  ...
                  <div className="space-y-3">
                    <p className="text-sm font-bold text-zinc-300">ตัวอย่างขั้นตอนการวัดจริง:</p>
                    {[
            ...
            {activeLesson === "voltage" && (
              <div className="space-y-6">
                <div className="bg-zinc-900/40 border border-zinc-800 rounded-2xl p-6 space-y-5">
                  <h2 className="text-xl font-black text-zinc-100">การอ่านค่าสเกลแรงดันไฟฟ้า (DCV / ACV)</h2>

                  <p className="text-zinc-400 text-xs sm:text-sm leading-relaxed">
                    การวัดแรงดันมีทั้งกระแสตรง (<strong className="text-white">DCV</strong>) และกระแสสลับ (<strong className="text-white">ACV</strong>) มัลติมิเตอร์จะมีสเกลตัวเลขหลักอยู่ 3 แถวคือ <strong className="text-indigo-400 font-mono">0-10, 0-50, และ 0-250</strong> ซึ่งเราจะเลือกอ่านแถวไหนขึ้นอยู่กับย่านวัดที่เราตั้งค่า
                  </p>

                  <div className="bg-zinc-950/60 border border-zinc-800 rounded-xl p-4 space-y-3">
                    <p className="text-xs font-bold text-zinc-400 uppercase tracking-wider">หลักการอ่านสเกลให้ตรงย่านวัดที่บิด</p>
                    <div className="space-y-2.5 text-xs text-zinc-300 font-medium">
                      <div className="flex justify-between items-center border-b border-zinc-850 pb-2">
                        <span className="font-bold text-zinc-200">ตั้งย่านวัดที่ 10V</span>
                        <span>ให้อ่านจากแถวตัวเลขสเกล <strong className="text-indigo-400 font-bold">0-10</strong> (แต่ละขีดเล็ก = 0.2V)</span>
                      </div>
                      <div className="flex justify-between items-center border-b border-zinc-850 pb-2">
                        <span className="font-bold text-zinc-200">ตั้งย่านวัดที่ 50V</span>
                        <span>ให้อ่านจากแถวตัวเลขสเกล <strong className="text-indigo-400 font-bold">0-50</strong> (แต่ละขีดเล็ก = 1.0V)</span>
                      </div>
                      <div className="flex justify-between items-center pb-1">
                        <span className="font-bold text-zinc-200">ตั้งย่านวัดที่ 250V</span>
                  ...
                  <div className="space-y-3 pt-2">
                    <p className="text-sm font-bold text-zinc-300">ตัวอย่างการอ่านแรงดันกระแสตรง (DCV):</p>
                    <div className="space-y-2 text-xs sm:text-sm text-zinc-400 leading-relaxed">
                      ...
                      <p>• คำนวณขีด: เลข 30 + 4 ขีดเล็ก (ขีดละ 1V) = <strong className="text-white font-bold">34 V</strong></p>
                    </div>
                  </div>
                </div>
            ...
            {activeLesson === "simulator" && (
              <div className="space-y-6">
                <div className="bg-zinc-900/40 border border-zinc-800 rounded-2xl p-6 space-y-4">
                  <h2 className="text-xl font-black text-zinc-100">ระบบจำลองการวัดหน้าปัดมัลติมิเตอร์</h2>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <Card className="bg-zinc-900/60 border-zinc-800 rounded-xl overflow-hidden flex flex-col py-0 gap-0">
                    <CardHeader className="border-b border-zinc-850 pt-4 pb-4 px-4">
                      <CardTitle className="text-sm font-bold text-zinc-200">หน้าปัดเข็มจำลอง</CardTitle>
                    </CardHeader>
                    <CardContent className="p-4 flex-1 flex flex-col justify-between gap-4">
                      <div className="flex justify-center py-6 min-h-[250px] bg-zinc-950/20 rounded-lg">
                  ...
                  <Card className="bg-zinc-900/60 border-zinc-800 rounded-xl overflow-hidden flex flex-col py-0 gap-0">
                    <CardHeader className="border-b border-zinc-850 pt-4 pb-4 px-4">
                      <CardTitle className="text-sm font-bold text-zinc-200">แผงควบคุมและวิธีคำนวณ</CardTitle>
                    </CardHeader>
                    <CardContent className="p-4 flex-1 flex flex-col justify-between gap-6">
                      <div className="space-y-3">
                        <label className="text-[10px] font-bold text-zinc-400 uppercase tracking-wider">เลือกย่านวัด (Range)</label>
                            ...
                            <Button
                              ...
                              className={cn(
                                ...
                                selectedRange.name === range.name
                                  ? range.type === "OHM" ? "bg-blue-600 hover:bg-blue-700 text-white" : "bg-emerald-600 hover:bg-emerald-700 text-white"
                      ...
                      <div className="p-4 rounded-xl bg-zinc-950/60 border border-zinc-850 space-y-3.5 text-xs">
                        <div className="flex justify-between items-center border-b border-zinc-850 pb-2.5">
                          ...
                          <span className="text-base font-bold font-mono text-zinc-200">{pointerValue}</span>
                        </div>
                        <div className="flex justify-between items-center border-b border-zinc-850 pb-2.5">
            ...
            {activeLesson === "quiz" && (
              <div className="space-y-5">
                <div className="bg-zinc-900/40 border border-zinc-800 rounded-2xl p-6">
                  <h2 className="text-xl font-black text-zinc-100 mb-1">ทดสอบความเข้าใจมัลติมิเตอร์</h2>
                  ...
                  <div className="space-y-8">
                    {QUIZ.map((q, qi) => (
                      <div key={qi} className="space-y-4 border-b border-zinc-850/60 pb-8 last:border-b-0 last:pb-0">
                        ...
                        <div className="bg-zinc-950/30 border border-zinc-850/80 rounded-2xl p-4 flex justify-center shadow-inner">
